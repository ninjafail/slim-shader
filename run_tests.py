...
for test in sorted(tests):
    ...
    if r.returncode < 0 and r.returncode != -6:
        signal = {
            2: "interrupt",
            8: "floating point exception",
            11: "segmentation fault",
        }.get(-r.returncode, f"signal {-r.returncode}")
        print(f"  \033[91mcrashed\033[0m due to {signal}")
    elif r.returncode == 0xC0000005:
        print(f"  \033[91mcrashed\033[0m due to access violation")
